...
#| warning: false
#| message: false
pkgs <- c( "rmarkdown","knitr","dplyr","ggplot2","readxl","janitor","stringr","tidyr", "tidytext","cluster","factoextra","gridExtra","RColorBrewer","scales","kableExtra","DT","gt","showtext","forcats","purrr")

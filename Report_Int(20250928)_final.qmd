...
#| warning: false
#| message: false
pkgs <- c("rmarkdown","knitr","tidyverse","dplyr","ggplot2","readxl","janitor","stringr","scales","RColorBrewer","tidyr", "tidytext","cluster","factoextra","gridExtra","kableExtra","DT","gt","showtext","forcats", "purrr")
